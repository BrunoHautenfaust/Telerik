namespace Telerik.ILS.Common
{
    ...
    {
        /// <summary>
        /// Creates a MD5Hash value
        /// </summary>
        /// <param name="input">String value to convert to MD5Hash</param>
        ...
        /// <summary>
        /// Check whether the input string contains a truthy value
        /// </summary>
        ...
        /// <summary>
        /// Converts input to Integer(32-bit)
        /// </summary>
        /// <param name="input">string value</param>
        ...
        /// <summary>
        /// Converts first letter of a string to capital
        /// </summary>
        /// <param name="input">string value</param>
        ...
        /// </summary>
        /// <param name="input">string values - start, end, startFrom</param>
        /// <returns>string</returns>
        public static string GetStringBetween(this string input, string startString, string endString, int startFrom = 0)
        {
            input = input.Substring(startFrom);
            startFrom = 0;
            // If there are no start and end string passed as arguments
        ...
        /// <summary>
        /// Replaces a username from cyrillic letters to latin
        /// </summary>
        /// <param name="input">string value</param>
        ...
        /// <summary>
        /// Replaces a username from latin letters to cyrillic
        /// </summary>
        /// <param name="input">string value</param>
        ...
        /// <summary>
        /// Returns a file extension based on its type
        /// </summary>
